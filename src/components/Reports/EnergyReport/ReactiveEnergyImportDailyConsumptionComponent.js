...
import DailyConsumptionChartComponent from "./ReactiveEnergyImportDailyConsumptionChartComponent";
import DailyConsumptionMUITableComponent from "./ReactiveEnergyImportDailyConsumptionMUITableComponent";
      ...
      <Grid item>
        <Paper className={classes.paper}>
          <Typography variant="h5" gutterBottom>
            {t("reportsReactiveEnergyImportReportGroupConsumptionTitle")}
          </Typography>
          <Grid
            container
            direction="column"
