...
import DailyConsumptionChartComponent from "./DailyConsumptionChartComponent";
import DailyConsumptionMUITableComponent from "./DailyConsumptionMUITableComponent";
      ...
      <Grid item>
        <Paper className={classes.paper}>
          <Typography variant="h5" gutterBottom>
            {t("reportsEnergyReportDailyConsumptionTitle")}
          </Typography>
          <Grid
            container
            direction="column"
